...
@click.option("--source_documents_dir", default="./SOURCE_DOCUMENTS", show_default=True, help="Slides/PDF/docs directory")
@click.option("--class_transcript_dir", default="./class_transcript", show_default=True, help="YouTube transcript directory")
